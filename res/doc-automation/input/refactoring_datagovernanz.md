...
{{dataGovernance.description}}
{{dataGovernance.purpose.list}}
...
@attach datagov_beispiel_mars | Die Grafik zeigt das Rollenmodell anhand des Beispiels MARS (Marktdaten Analyse- und Reporting-System).
...
## 3.3 {{dataArchitect.label}}

### 3.3.1 Kurzbeschreibung
{{dataArchitect.description}}

### 3.3.2 Aufgaben
{{dataArchitect.responsibility}}

### 3.3.3 Entscheidungskompetenzen
{{dataArchitect.authority}}

### 3.3.4 Verantwortung
{{dataArchitect.accountability}}



## 3.4 {{applicationOwner.label}}

### 3.4.1 Kurzbeschreibung
{{applicationOwner.description}}

### 3.4.2 Aufgaben
{{applicationOwner.responsibility}}

### 3.4.3 Entscheidungskompetenzen
{{applicationOwner.authority}}

### 3.4.4 Verantwortung
{{applicationOwner.accountability}}

## 3.5 {{informationSecurityOfficer.label}}
...
### 3.6.3 Entscheidungskompetenzen
...
### 3.7.3 Entscheidungskompetenzen
{{dataUser.authority}}
